...
class JobSeekerSkillList extends StatefulWidget {
  @override
  _JobSeekerSkillListState createState() => _JobSeekerSkillListState();
}

class _JobSeekerSkillListState extends State<JobSeekerSkillList> {
    ...
    FirebaseAuth.instance.currentUser().then(
          (user) => {
            Firestore.instance
              ...
              jobListingWidget.addAll(_jobListingModalList.map((jobListing) {
                return Container(
