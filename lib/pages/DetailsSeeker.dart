...
class DetailsSeeker extends StatefulWidget {
  @override
  _DetailsSeekerState createState() => _DetailsSeekerState();
}

class _DetailsSeekerState extends State<DetailsSeeker> {
                    ...
                    child: Text.rich(
                      TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text:
                                'MS in Computer Science, BTech in Electronics Engineering, 20+ years of software development experience using multiple latest technologies. Excellent knowledge of business processes...',
                            style: TextStyle(
                              color: const Color(0xff3c3d4d),
                              fontWeight: FontWeight.w500,
                            ),
              ...
              child: Column(
                children: [
                  ...
                  JobDesciptionItem(
                      ...
                      jobTitleText: "Skillset/Offer ID: ",
                      jobTitleValue: "S-12345678909"),
                  JobDesciptionItem(
                      icon: Icon(Icons.person_outline),
