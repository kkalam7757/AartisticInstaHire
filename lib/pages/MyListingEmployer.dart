...
class MyListingEmployer extends StatefulWidget {
  @override
  _MyListingEmployerState createState() => _MyListingEmployerState();
}

class _MyListingEmployerState extends State<MyListingEmployer> {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    JobDesciptionItem(icon: Icon(Icons.person_outline), jobTitleText: "Job Title: ", jobTitleValue: "Software Development Manager"),
                    JobDesciptionItem(icon: Icon(Icons.list), jobTitleText: "Listing ID: ", jobTitleValue: "L-12345678909"),
                    ...
                    JobDesciptionItem(icon: Icon(Icons.person_outline), jobTitleText: "Description: ", jobTitleValue: "Must have project management experience in web/mobile app.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor"),
                    Padding(
