...
class MyOrdersJobSeeker extends StatefulWidget {
  @override
  _MyOrdersJobSeekerState createState() => _MyOrdersJobSeekerState();
}

class _MyOrdersJobSeekerState extends State<MyOrdersJobSeeker> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            SizedBox(height: 15),
            Text('Job-seeker ID: J-12345678909',
                style: TextStyle(
  ...
  Container myOrderJobSeekerItem() {
    return Container(
